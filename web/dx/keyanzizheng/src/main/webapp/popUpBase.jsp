...
<script type="text/javascript" src="${basePath}/static/js/plugins/jquery.flot.min.js"></script>
<script type="text/javascript" src="${basePath}/static/js/plugins/jquery.flot.resize.min.js"></script>
...
<script type="text/javascript" src="${basePath}/static/js/custom/dashboard.js"></script>
