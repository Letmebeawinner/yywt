...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/ky/zhuzuoDetailsStatistics.json" method="post">
        ...
        <div class="pr">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <thead>
                <tr>
                    <th class="head0 center">类别 (点击可跳转到成果列表)</th>
                    <th class="head0 center">个数 (点击可跳转到成果列表)</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${series}" varStatus="status" var="s">
                    <tr onclick="location.href='${ctx}/admin/ky/getResultList.json?queryResult.resultForm=2&queryResult.resultType=1&queryResult.journalNature=${s.secId}'">
                        <td>${s.name}</td>
                        <td>${s.data}</td>
                    </tr>
                </c:forEach>
