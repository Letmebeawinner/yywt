        ...
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="bill">
                <p>
                    ...
                    <span class="field">
						 <input type="text" name="awardTitle" class="longinput"/>
					</span>
                </p>
                ...
                <p>
                    ...
                    <span class="field">
                        <select name="resultForm" id="resultForm" onchange="chgRadio(this)">
                ...
                <p>
                    <label>获奖情况</label>
                    <span class="field">
                        <input type="radio" value="1" checked="checked" name="awardSituation"/><span
                            id="aw-1">国家级奖</span>&nbsp;&nbsp;
                        <input type="radio" value="2" name="awardSituation"/><span id="aw-2">省部级奖</span>&nbsp;&nbsp;
                        <input type="radio" value="3" name="awardSituation"/><span id="aw-3">地市级奖</span>&nbsp;&nbsp;
                        <input type="radio" value="4" name="awardSituation"/><span id="aw-4">其他</span>&nbsp;&nbsp;
                    </span>
                </p>
                <p>
                    <label>获奖情况描述
                    ...
                    <span class="field"><textarea cols="80" rows="5" name="digest" id="digest"
                ...
                <p>
                    ...
                    <span class="field">
						 <input type="hidden" name="fileUrlAward" id="fileUrl"/>
						 <input type="button" id="uploadFile" value="获奖申报附件"/>
