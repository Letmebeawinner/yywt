...
<div class="centercontent tables">
    <div class="pageheader notab" style="margin-left: 10px">
        <h1 class="pagetitle">${title}统计</h1>
        <span>
    ...
    <div id="contentwrapper" class="contentwrapper">
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm"
                      action="${ctx}/admin/ky/detailAwardStatistics.json?resultForm=${resultForm}" method="post">
        ...
        <div class="pr">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <thead>
                <tr>
                    <th class="head0 center">${title}类型</th>
                    <th class="head0 center">个数</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${series}" varStatus="status" var="s">
                    <tr onclick="location.href='${ctx}/admin/ky/award/list.json?resultForm=${resultForm}&awardSituation=${s.secId}'">
                        <td>${s.name}</td>
                        <td>${s.data}</td>
                    </tr>
                </c:forEach>
