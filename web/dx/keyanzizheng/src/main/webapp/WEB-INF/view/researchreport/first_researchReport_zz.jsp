...
<head>
    ...
    <script type="text/javascript">
        ...
        function audit(id, audit) {
            var msg = "";
            var firstDraft = jQuery("input[name='firstDraft']").val()
            if (audit === 1) {
                if (!firstDraft) {
                    alert("初稿查重率为空, 请填写")
                    jQuery("input[name='firstDraft']").focus()
                    return false
                }
                msg = "是否通过审批?"
            }
            ...
            if (confirm(msg)) {
                jQuery.ajax({
                    ...
                    data: {
                        ...
                        "researchReport.firstDraft": firstDraft
                    },
                    type: 'post',
                    dataType: 'json',
        ...
        <div id="basicform" class="subcontent">
            ...
            <form id="form1" class="stdform stdform2" method="post" action="">
                ...
                <p>
                    ...
                    <span class="field">
                        <input type="text" value="" class="longinput" name="firstDraft" onblur="trim(this)"
                               maxlength="100">
                    </span>
                </p>
