...
<head>
    ...
    <script type="text/javascript">
        ...
        function addFormSubmit() {
            ...
            jQuery.ajax({
                url: "${ctx}/admin/ky/doSaveResultArchive.json",
                ...
                success: function (result) {
                    ...
                    if (result.code === "0") {
                        window.location.href = "${ctx}/admin/ky/getResultStorageList.json?queryResult.resultType=1"
                            + "&queryResult.resultForm=" + result.data.resultForm;
                    }
                }
            });
        }
