...
<head>
    ...
    <script type="text/javascript">
        ...
        function delMeetingTopic(id) {
            if (confirm('您确定要删除吗?')) {
                jQuery.ajax({
                    url: '/admin/ky/projectTemplateManagement/del.json?id=' + id,
                    type: 'post',
                    dataType: 'json',
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                ...
                <div class="disIb ml20 mb10">
                    <a href="${ctx}/admin/ky/projectTemplateManagement/save.json"
                       class="stdbtn btn_orange">添加模板</a>
                </div>
            </div>
        </div>
        <!-- 搜索条件，结束 -->
                        ...
                        <tr>
                            ...
                            <td class="center">
                                <a href="${projectTemplate.url}"
                                   class="stdbtn" title="下载模板">下载模板</a>
