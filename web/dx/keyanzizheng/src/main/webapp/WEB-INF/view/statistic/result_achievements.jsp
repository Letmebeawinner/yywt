...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/ky/scientificAchievements.json" method="post">
        ...
        <div class="pr">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <thead>
                <tr>
                    <th class="head0 center">成果类型 (点击可跳转到成果列表)</th>
                    <th class="head0 center">个数 (点击可跳转到成果列表)</th>
                </tr>
                </thead>
                <tbody>
                <tr onclick="location.href='${ctx}/admin/ky/getResultList.json?queryResult.resultForm=1&queryResult.resultType=1'">
                    <td>论文</td>
                    <td>
                        ${lunwen}
                    </td>
                </tr>
                <tr onclick="location.href='${ctx}/admin/ky/getResultList.json?queryResult.resultForm=2&queryResult.resultType=1'">
                    <td>著作</td>
                    <td>${zhuzuo}
                    </td>
                </tr>
                <tr onclick="location.href='${ctx}/admin/ky/getResultList.json?queryResult.resultForm=3&queryResult.resultType=1'">
                    <td>课题</td>
                    <td>${keti}
                    </td>
                </tr>
                <tr onclick="location.href='${ctx}/admin/ky/getResultList.json?queryResult.resultForm=4&queryResult.resultType=1'">
                    <td>内刊</td>
                    <td>${neikan}
                    </td>
                </tr>
                <tr onclick="location.href='${ctx}/admin/ky/rr/listResearchReport.json?resultType=1'">
                    <td>调研报告</td>
                    <td>${baogao}
                    </td>
                </tr>
                <tr onclick="location.href='${ctx}/admin/ky/getResultList.json?queryResult.resultForm=5&queryResult.resultType=1'">
                    <td>其他</td>
                    <td>${qita}
                    </td>
                </tr>
