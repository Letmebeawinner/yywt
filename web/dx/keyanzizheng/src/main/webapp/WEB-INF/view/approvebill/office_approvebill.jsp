...
<div class="centercontent">
    <div class="pageheader" style="margin-left: 10px">
        <h1 class="pagetitle">${resultTypeName}审批</h1>
        <span>
                <span style="color:red">说明</span><br>
                1. 本页面用来${resultTypeName}对课题进行审批<%--，其中审批文件为保留部门批示笔记的文件（照片等形式）--%><br>
        ...
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="saveForm">
                ...
                <p>
                    ...
                    <span class="field">
                        <c:if test="${result.level==1}">国级&nbsp;&nbsp; </c:if>
                        <c:if test="${result.level==2}">省级&nbsp;&nbsp; </c:if>
                ...
                <p class="stdformbutton" style="text-align: center">
                    <button class="submit radius2" onclick="save(2, '${approveBill.resultId}');return false;">同意
                    </button>
                    <button class="submit radius2" onclick="save(1, '${approveBill.resultId}');return false;">拒绝
                    </button>
