...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/ky/awardStatistics.json" method="post">
        ...
        <div class="pr">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <c:forEach items="${series}" varStatus="status" var="s">
                    <tr onclick="location.href='${ctx}/admin/ky/award/list.json?resultForm=${s.secId}'">
                        <td>${s.name}</td>
                        <td>${s.data}</td>
                    </tr>
                </c:forEach>
