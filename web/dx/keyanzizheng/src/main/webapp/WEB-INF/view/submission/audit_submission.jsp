        ...
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="saveForm">
                ...
                <p class="stdformbutton" style="text-align: center">
                    <button class="submit radius2" onclick="auditSubmission('${submission.id}', '1');return false;">同意
                    </button>
                    <button class="submit radius2" onclick="auditSubmission('${submission.id}', '2');return false;">拒绝
                    </button>
