...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/statistic/analysis/logistics/listElectricFee.json">
        ...
        <span>
            ...
            共用电${totalConsume}千瓦·时，支出<fmt:formatNumber value="${totalExpense}" pattern="0.00" /> 元。
        </span>
        <!-- 数据显示列表，开始 -->
        <div class="pr">
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <thead>
                <tr>
                    <th class="head1 center">用电量(kW·h)</th>
                    <th class="head0 center">用电支出(￥)</th>
