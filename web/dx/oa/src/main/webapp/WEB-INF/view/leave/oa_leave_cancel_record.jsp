...
<div class="centercontent">
    ...
    <div id="contentwrapper" class="contentwrapper users-car">
        <form method="post" action="" id="submitForm">
            ...
            <input type="hidden" name="oaLeave.schoolLeaderAuditTime" value="<fmt:formatDate value="${nowDate}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate>">
            ...
            <div class="testtle-tables">
                <table border="1">
                    ...
                    <tr>
                        <td class="pt" rowspan="4"><small class="c-red">*</small>销假备案情况</td>
                        <td class="pt" rowspan="4" style="border-right: none; color:#666;"><textarea cols="30" rows="3" name="oaLeave.cancelLeaveRecordSituation" id = "cancelLeaveRecordSituation">${oaLeave.cancelLeaveRecordSituation}</textarea></td>
                        <td colspan="2" style="border: none;border-right: 1px solid #ddd; "></td>
                    </tr>
                    <tr>
                        <td class="pt" colspan="2" style="border:none; color:#666;border-right: 1px solid #ddd;">
                            <p class="testtle-txt">请假人已于年 月 日</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="pt" colspan="2" style="border:none; color:#666;border-right: 1px solid #ddd;" >
                    ...
                    <tr>
                        <td class="pt" colspan="2" style="border:none; color:#666;border-right: 1px solid #ddd;border-bottom: 1px solid #ddd;" >
                            <p class="testtle-txt"><small class="c-red">*</small>组织人事处备案人（签字）：<input id="cancelLeaveRecordSign" name="oaLeave.cancelLeaveRecordSign" type="text" class="qz" /></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="pt">审核状态</td>
                ...
                <a class="submit radius2" style="cursor: pointer" onclick="addFormSubmit(1);return false;">提交</a>
...
<script type = "text/javascript">
    ...
    function addFormSubmit(flag) {
        if (!jQuery("#cancelLeaveRecordSituation").val()) {
            alert("销假备案情况不能为空");
            return;
        }
        if (!jQuery("#cancelLeaveRecordSign").val()) {
            alert("销假备案人签字不能为空");
            return;
        }

        jQuery("#audit").val(flag);
        jQuery("#comment").val(jQuery("#cancelLeaveRecordSituation").val());
