...
<div class="centercontent">
    <div class="pageheader">
        <h1 class="pagetitle printHide">分管办公室校领导审批</h1>
    </div>
    <div>
        <input type="button" class="test" style="margin: 0 0 20px 21px;cursor: pointer" value="电子签章" onclick="clickSignature(this, 'pos2')">
    </div>
