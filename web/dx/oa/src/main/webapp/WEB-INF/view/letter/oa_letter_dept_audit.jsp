...
<div class="centercontent">
    <div class="pageheader">
        <h1 class="pagetitle printHide">部门领导审批</h1>
    </div>
    <div>
        <input type="button" class="test" style="margin: 0 0 20px 21px;cursor: pointer" value="电子签章" onclick="clickSignature(this, 'pos0')">
    </div>
    <div id="contentwrapper" class="contentwrapper user-car">
        <div id="basicform" class="subcontent">
            <div class="testtle-tables Noprint" id="documentPrintID">
                <form id="addLetter" method="post" class="stdform stdform2">
                    ...
                    <input type="hidden" name="oaLetter.processInstanceId" value="${oaLetter.processInstanceId}"
