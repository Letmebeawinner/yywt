...
<head>
    ...
    <script type="text/javascript">
        ...
        function addFormSubmit() {
            ...
            jQuery.ajax({
                url: "${ctx}/admin/oa/addSaveRule.json",
        ...
        <div id="basicform" class="subcontent">
            ...
            <form class="stdform stdform2" method="post" action="" id="addFormSubmit">
                <p>
                    ...
                    <span class="field"><input type="text" name="rule.name" id="title" class="longinput"/></span>
                </p>
                <p>
                    <label>类型名称</label>
                    <span class="field">
                ...
                <p>
                    ...
                    <span class="field"><input type="text" name="rule.source" class="longinput"/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>作者</label>
                    <span class="field"><input type="text" name="rule.author" class="longinput"/></span>
                </p>
                <p>
                    <label>浏览量</label>
                    <span class="field"><input type="text" name="rule.views" class="longinput"/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>规章制度地址:</label>
					 <span class="field">
						 <input type="hidden" name="rule.fileUrl"   id="fileUrl" />
                ...
                <p>
                    <label>内容</label>
                    <span class="field">
                        <textarea rows="8" cols="5" name="rule.context" class="longinput"></textarea>
                    </span>
                </p>
