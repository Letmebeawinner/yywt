...
//            }
            ...
            jQuery.ajax({
                url: "${ctx}/admin/oa/inner/letter/process/start.json",
                data: data + "&userIds=" + userIds.substr(0, userIds.length),
                type: "post",
                dataType: "json",
                async: false,
                cache : false,
        ...
        <div id="basicform" class="subcontent">
                <div class="testtle-tables">
                    ...
                    <table border="1">
                        ...
                        <tr>
                            <td class="pt" colspan="4" style="text-align: left;padding-left: 40px; color:#666;"><tt><small class="c-red" style = "display: inline-block; vertical-align: top">*</small>文件标题：</tt><span><textarea name="oaLetter.reason" id="reason" style="width:88%;" cols="20" rows="5"></textarea></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                           <td class="pt" colspan="4" style="text-align: left;padding-left: 40px; color:#666;"><tt>发送单位：</tt><span><textarea name="oaLetter.sendToUnit" id="sendToUnit" style="width:88%;" cols="10" rows="5"></textarea></span></td>
                        </tr>
                        <tr>
                           <td class="pt" colspan="4" style="text-align: left;padding-left: 40px; color:#666;"><tt>内容摘要：</tt><span><textarea name="oaLetter.context" id="context" style="width:88%;" cols="10" rows="5"></textarea></span></td>
                        </tr>
                        <tr>
                            <td class="pt">公文内容(在线Word)</td>
                            <td colspan="3">
                                <span class="field">
                                         <a href="javascript:void(0)" onclick="openPageOffice()" class="ZL-generate">编辑公文内容</a>
                                </span>
                            </td>
                        </tr>
                        ...
                        <input type = "hidden" value = "2" name = "oaLetter.type"/>
                        <input type = "hidden" name="oaLetter.timeStamp" id = "timeStamp"/>
                    </form>
