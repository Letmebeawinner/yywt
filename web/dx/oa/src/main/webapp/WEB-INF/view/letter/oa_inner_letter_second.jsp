...
<head>
    ...
    <script type="text/javascript">
        function addFormSubmit(flag) {
            var confirmOption = jQuery("#countersignOption").val();
            if (!confirmOption) {
                alert("会签信息必填");
                return;
            }
                ...
                <div class="testtle-tables">
                    ...
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="text_controller_center">会&nbsp;&nbsp;&nbsp;&nbsp;签：<input style="width:85%;height:110px;" type = "text" name = "oaLetter.countersignOption" id = "countersignOption"/></td>
                        </tr>
                        <tr>
