...
<div class="pr">
    <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
        ...
        <thead>
        <tr>
            <th class="head0 center"><input id="checkAll" type="checkbox" onclick="checkAllNext(this)"/></th>
        ...
        <c:forEach items="${userList}" var="user">
            <tr>
                <td style="width: 50px">
                    <input <c:if test="${selectType==1}"> type="radio" name="type" </c:if> <c:if test="${selectType!=1}"> type="checkbox"</c:if> value="${user.id}" onclick="checkNext(this)" class="users">
                </td>
...
<script type="text/javascript">
    ...
    function searchReceivers() {
        ...
        jQuery.ajax({
            url: '/admin/oa/ajax/queryReceivers.json',
            data: param,
            type: 'POST',
            dataType: 'html',
