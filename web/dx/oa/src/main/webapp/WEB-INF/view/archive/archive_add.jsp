...
<head>
    ...
    <script type="text/javascript">
        ...
        function addFormSubmit() {
            ...
            jQuery.ajax({
                url: "${ctx}/admin/oa/addArchive.json",
        ...
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="addFormSubmit">
                ...
                <p>
                    ...
                    <span class="field"><input type="text" name="archive.danghao" id="danghao" class="longinput"/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>档案件号</label>
                    <span class="field"><input type="text" name="archive.jianhao" id="jianhao" class="longinput"/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>责任者</label>
                    <span class="field"><input type="text" name="archive.author" id="author" value="贵阳市委党校" class="longinput" readonly/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>题名</label>
                    <span class="field"><input type="text" name="archive.autograph" id="autograph" class="longinput"/></span>
                </p>
                <p>
                ...
                <p>
                    ...
                    <span class="field"><input type="text" name="archive.archivedate" id="archivedate" class="longinput" readonly/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>页数</label>
                    <span class="field"><input type="text" name="archive.pages" id="pages" class="longinput" placeholder = "请输入数字" maxlength="8" onkeyup="value=this.value.replace(/\D+/g,'')"
                                               style="ime-mode:Disabled"/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>机构或问题</label>
                    <span class="field"><input type="text" name="archive.orginzation" id="orginzation" class="longinput"/></span>
                </p>
                <p>
