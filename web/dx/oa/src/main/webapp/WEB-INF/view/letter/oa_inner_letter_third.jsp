...
<head>
    ...
    <script type="text/javascript">
        function addFormSubmit(flag) {
            var confirmOption = jQuery("#confirmToSendOption").val();
            if (!confirmOption) {
                alert("签发信息必填");
                return;
            }
        ...
        <div id="basicform" class="subcontent">
                <div class="testtle-tables">
                    ...
                    <table border="1">
                        ...
                        <tr>
                           <td class="pt" colspan="4" style="text-align: left;padding-left: 40px; color:#666;"><tt>签发：</tt><input style="width:85%;height:110px;" type = "text" name = "oaLetter.confirmToSendOption" id = "confirmToSendOption"/></td>
                        </tr>
                        <tr>
