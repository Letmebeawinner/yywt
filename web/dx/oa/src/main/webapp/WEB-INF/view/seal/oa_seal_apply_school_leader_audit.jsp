                ...
                <form id = "sealApplyDeptAudit" method="post">
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td class="pt text_controller_center"><small class="c-red" style = "display: inline-block; vertical-align: top">*</small>常务副校长/副校长（主持工作）意见</td>
                            <td class="pt">
                                <span style="padding: 0;"><textarea id="schoolLeaderOption" name="sealApply.schoolLeaderOption" style="width:95%;" cols="20" rows="5">${oaSeal.schoolLeaderOption}</textarea></span>
