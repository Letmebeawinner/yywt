...
<div class="centercontent">
    ...
    <div id="contentwrapper" class="contentwrapper users-car">
        <form method="post" action="" id="submitForm">
            ...
            <input type="hidden" name="oaLeave.cancelLeaveRecordTime" value="<fmt:formatDate value="${nowDate}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate>">
            ...
            <div class="testtle-tables">
                <table border="1">
                    ...
                    <tr>
                        <td class="pt" colspan="2" style="border:none; color:#666;border-right: 1px solid #ddd;" >
                            <p class="testtle-txt"><small class="c-red">*</small>请假人（签字）：<input id="applySign" name="oaLeave.applySign" type="text" class="qz" /></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="pt" colspan="2" style="border:none; color:#666;border-right: 1px solid #ddd;border-bottom: 1px solid #ddd;" >
...
<script type = "text/javascript">
    ...
    function addFormSubmit(flag) {
        ...
        if (!jQuery("#applySign").val()) {
            alert("请假人签字不能为空");
            return;
        }
        jQuery("#audit").val(flag);
        jQuery("#comment").val("销假签字");
