...
<head>
    ...
    <script type="text/javascript">
        function addFormSubmit() {
            ...
            jQuery.ajax({
                url: "${ctx}/admin/oa/addSaveFlowType.json",
        ...
        <div id="basicform" class="subcontent">
            ...
            <form class="stdform stdform2" method="post" action="" id="addFormSubmit">
                ...
                <p>
                    ...
                    <span class="field"><input type="text" name="flowType.name" id="name" class="longinput"/></span>
                </p>
                <p>
                    <label>排序</label>
                    <span class="field"><input type="text" name="flowType.sort" id="sort" class="longinput" onkeyup="value=value.replace(/[^\d]/g,'')" value="0"/></span>
                </p>
            </form>
