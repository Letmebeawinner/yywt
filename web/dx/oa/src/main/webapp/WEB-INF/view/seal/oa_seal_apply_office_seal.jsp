...
<div class="centercontent">
    ...
    <div>
        <input type="button" class="test" style = "margin-left: 21px;cursor: pointer" value="电子签章" onclick = "clickSignature(this, 'pos4')">
    </div>
        ...
        <div id="basicform" class="subcontent">
            <div class="testtle-tables">
                <form id = "sealApplyDeptAudit" method="post">
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="pt"><span style="padding: 0;"><input type="text" name = "sealApply.useSealTime" value="<fmt:formatDate value="${oaSeal.useSealTime}" pattern="yyyy-MM-dd"></fmt:formatDate>" style="width:90%;" id = "useSealTime"></span></td>
                        </tr>
                ...
                <div class="buttons" style="text-align: center;margin-top:20px;margin-bottom: 20px">
                    <a class="submit radius2" onclick = "sealFormSubmit(1)" style="cursor: pointer">提交</a>
