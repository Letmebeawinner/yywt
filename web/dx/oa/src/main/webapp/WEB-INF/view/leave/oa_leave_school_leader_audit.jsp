...
<div class="centercontent">
    ...
    <div>
        <input type="button" class="test" style = "margin-left: 21px;cursor: pointer" value="电子签章" onclick = "clickSignature(this, 'pos2')">
    </div>
        ...
        <form method="post" action="" id="submitForm">
            ...
            <div class="testtle-tables">
                <table border="1">
                    ...
                    <tr>
                        <td class="pt" rowspan="2"><small class="c-red">*</small>常务副校长/副校长（主持工作）审批意见</td>
                        <td class="pt" rowspan="2" style="border-right: none; color:#666;"><textarea cols="30" rows="3" name="oaLeave.schoolLeaderOption" id = "schoolLeaderOption">${oaLeave.schoolLeaderOption}</textarea></td>
                        <td colspan="2" style="border: none;border-right: 1px solid #ddd; "></td>
                    </tr>
                    <tr>
                        <td class="pt" colspan="" style="border:none;border-bottom: 1px solid #ddd; color:#666;">签字：</td>
...
<script type = "text/javascript">
    ...
    var schoolAuditTime='${oaLeave.schoolAuditTime}';
    function addFormSubmit(flag) {
        if (!jQuery("#schoolLeaderOption").val()) {
            alert("常务副校（院）长意见不能为空");
            return;
        }
        ...
        if(departAuditTime==null || departAuditTime==""){
            if(schoolAuditTime==null || schoolAuditTime==""){
                if (i < 1) {
                    alert("审批必须签字");
                    return;
                }
        ...
        jQuery("#comment").val(jQuery("#schoolLeaderOption").val());
