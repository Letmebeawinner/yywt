            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <c:forEach items="${archiveList}" var="archive" varStatus="status">
                    <tr>
                        ...
                        <td>
                            <%--<a href="${archive.file}" title="下载附件">${archive.fileName}</a>--%>
                            <a href="${ctx}/admin/oa/file/load.json?fileUrl=${archive.file}&fileName=${archive.fileName}" title="下载附件">${archive.fileName}</a>
                        </td>
                        <%--<td>${archive.pages}</td>--%>
