...
//            }
            ...
            // if (jQuery("input[name='userIds']").val() == '' && flag==0) {
            //     jAlert("请选择分管校领导审批", "提示", function () {
            //     });
            //     return false
            // }
        ...
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="saveForm">
                ...
                <p>
                    ...
                    <span class="field">
                         <span id="location">&nbsp;<a class="close" id="mePresent_${oaMeetingAgenda.locationId}"> <i>${oaMeetingAgenda.location}</i><i class="fa fa-w c-999 fa-close" onclick="removeMeeting(this)"></i> </a></span>
                ...
                <p>
                    ...
                    <span class="field">
                        <%--<input type="text" name="agenda.compere" value="${oaMeetingAgenda.compere}" class="longinput">--%>
                ...
                <p>
                    ...
                    <span class="field">
                        ...
                        <%--<input type="text" name="agenda.record" class="longinput" value="${oaMeetingAgenda.record}">--%>
                    </span>
                </p>
                <p>
                ...
                <p class="stdformbutton" style="text-align: center">
                    ...
                    <%--<button id="chooseBtn" class="submit radius2" onclick = "chooseLeader();return false;">选择分管副校长审批</button>--%>
