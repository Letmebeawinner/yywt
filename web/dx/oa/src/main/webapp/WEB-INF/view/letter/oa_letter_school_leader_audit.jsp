...
<head>
    ...
    <script type="text/javascript">
        ...
        function addFormSubmit(flag) {
            var confirmToSendOption = jQuery("#confirmToSendOption").val();
//            if (!confirmToSendOption) {
//                alert("签发信息必填");
//                return;
//            }
            ...
            jQuery("#comment").val(confirmToSendOption);
...
<div class="centercontent">
    ...
    <div>
        <input type="button" style = "margin-left: 21px;cursor: pointer" class="test" value="电子签章" onclick = "clickSignature(this, 'pos4')">
    </div>
