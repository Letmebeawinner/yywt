...
%>
<%
  String mScriptName = "${ctx}/DocumentEdit.jsp";
  String mServerName="${ctx}/Service.jsp";
...
function PrintDocument(){
   ...
   var mCount = DocForm.SignatureControl.PrintDocument(false,1,5);  //打印控制窗体
   alert("实际打印份数："+mCount);
...
<param name="ServiceUrl" value="http://127.0.0.1:8087/Service.jsp?"><!--读去数据库相关信息-->
...
<tr>
  <td colspan=2 bgcolor="#c0c0c0" height=32>
    ...
    <input type="button" value=" 打印控制 "  onclick="PrintDocument();"><br>
