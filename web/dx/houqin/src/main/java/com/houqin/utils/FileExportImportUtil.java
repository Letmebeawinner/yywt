...
//            cell.setEncoding(HSSFCell.ENCODING_UTF_16);
    ...
    public static File createExcel(String[] headName, List<List<String>> list, String expName, String dir) throws Exception {
        ...
        for (int y = 0; y < headName.length; y++) {//循环表头信息
            sheet.setColumnWidth((short) y, (short) 5000);
...
//                cell.setEncoding(HSSFWorkbook.ENCODING_UTF_16);
     ...
     * @throws Exception
     */
    public static File createHeadExcel(String[] headName, List<List<String>> list, String expName, String dir,String head) throws Exception {
        // 格式化时间
        HSSFWorkbook workbook = new HSSFWorkbook();
        HSSFSheet sheet = workbook.createSheet("sheet1");
