	...
	<body>
	    <div class="centercontent tables">
	         <div class="pageheader notab" style="margin-left: 30px">
                <h1 class="pagetitle">批量导入食堂库存</h1>
                <span>
                    <span style="color:red">说明</span><br>
                    1.本页面用于批量导入食堂库存<br />
                    2.点击<a href="${ctx}/static/exceltemplate/import_mess.xls"
                       style="color:red">下载excel模板</a>,
                    参照模板的写法,填写食堂库存信息,批量导入.
				</span>
             </div><!--pageheader-->
             <div id="contentwrapper" class="contentwrapper">
				...
				<div id="validation" class="subcontent">
                    ...
                    <form id="form1" class="stdform" method="post" action="${ctx}/admin/houqin/batchAddImportMess.json" enctype="multipart/form-data">
                        <p>
                        	<label>上传</label>
                            <span class="field">
