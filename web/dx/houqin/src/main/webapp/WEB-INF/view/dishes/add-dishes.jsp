...
<head>
    ...
    <script type="text/javascript">
        ...
        function addFormSubmit() {
            ...
            jQuery.ajax({
                url: "${ctx}/admin/houqin/addSaveDishes.json",
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="addFormSubmit">
                <p>
                    <input type="hidden" name="dishes.messId" value="${messId}" id="messId">
                ...
                <p>
                    ...
                    <span class="field">
                        <input type="text" name="dishes.breakprice" class="longinput" id="breakprice"/>单位元
                    </span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>午餐</label>
                    <span class="field">
                        <input type="text" name="dishes.lunch" class="longinput" id="lunch"/>
                    </span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>午餐价格</label>
                    <span class="field">
                        <input type="text" name="dishes.lunchprice" class="longinput" id="lunchprice"/>单位元
                    </span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>晚餐</label>
                    <span class="field">
                        <input type="text" name="dishes.dinner" class="longinput" id="dinner"/>
                    </span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>晚餐价格</label>
                    <span class="field">
                        <input type="text" name="dishes.dinnerprice" class="longinput" id="dinnerprice"/>单位元
                    </span>
                </p>
                <p>
                ...
                <p>
                    <label>图片:</label>
                    <span class="field">
						 <input type="hidden" name="dishes.imagePath" id="fileUrl"/>
                ...
                <p>
                    <label>描述</label>
                    <span class="field">
                        <input type="text" name="dishes.description" class="longinput"/>
                    </span>
                </p>
                <p>
                    <label>农残检测</label>
                    <span class="field">
                        <input type="text" name="dishes.pesticideResidues" class="longinput"/>
                    </span>
                </p>
                <p>
                    <label>菜品检样</label>
                    <span class="field">
                        <input type="text" name="dishes.retentionSamples" class="longinput"/>
                    </span>
                </p>
                <%--新增字段结束--%>
                <p class="stdformbutton" style="text-align: center">
                    <button class="submit radius2" onclick="addFormSubmit();return false;">提交保存
                    </button>
                </p>
            </form>
        </div>
