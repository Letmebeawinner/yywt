...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/houqin/queryMyRepairList.json" method="post">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <c:forEach items="${repairList}" var="repair" varStatus="state">
                    <tr>
                        ...
                        <td class="center">
                            <a href="${ctx}/admin/houqin/descRepair.json?id=${repair.id}" class="stdbtn" title="详情">详情</a>
                            ...
                            <a href="${ctx}/admin/houqin/toAppraise.json?repairId=${repair.id}" class="stdbtn" title="评价">评价</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
