...
<head>
    ...
    <script type="text/javascript">
        ...
        function exportExcel() {
            jQuery("#searchForm").prop("action", "${ctx}/admin/houqin/exportNaturalExcel.json");
            jQuery("#searchForm").submit();
            jQuery("#searchForm").prop("action", "${ctx}/admin/houqin/statisticNatural.json");
        }
...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/houqin/statisticNatural.json" method="post">
        ...
        <div class="pr">
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <tr>
                    ...
                    <th class="head0 center">用量(立方米)</th>
                </tr>
                </thead>
                <tbody>
