...
<head>
    ...
    <script type="text/javascript">
        ...
        function addFormSubmit() {
            jQuery.ajax({
                url: "${ctx}/admin/houqin/addPropertyBorrow.json",
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="addFormSubmit">
                <p>
                    <input type="hidden" value="${userId}" name="propertyBorrow.userId"/>
                    <label><em style="color: red;">*</em>调入管理员</label>
                    <span class="field">
                        <input type="text" name="propertyBorrow.name" class="longinput" id="name"/>
                    </span>
                </p>
                ...
                <td>
                    <input type="hidden" value="" id="propertyId" name="propertyBorrow.propertyId">
                    <input type="hidden" value="" id="propertyTypeId" name="propertyBorrow.propertyTypeId">
                    <span class="field">
                ...
                <p>
                    <label><em style="color: red;">*</em>借出时间</label>
                    <span class="field">
                        <input type="text" name="propertyBorrow.borrowTime" class="longinput" readonly id="borrowTime"/>
                    </span>
                </p>
                ...
                <p>
                    <label>预计归还时间</label>
                    <span class="field">
                        <input type="text" name="propertyBorrow.beforereturnTime" class="longinput" readonly id="beforereturnTime"/>
                    </span>
                </p>
                ...
                <p>
                    <label>归还时间</label>
                    <span class="field">
                        <input type="text" name="propertyBorrow.returnTime" class="longinput" readonly id="returnTime"/>
                    </span>
                </p>
                ...
                <p>
                    ...
                    <span class="field">
                       <textarea rows="10" cols="5" class="longinput" name="propertyBorrow.description"></textarea>
                    </span>
                </p>
