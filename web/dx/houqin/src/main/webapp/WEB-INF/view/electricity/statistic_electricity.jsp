...
<head>
    ...
    <script type="text/javascript">
        ...
        function exportExcel() {
            jQuery("#searchForm").prop("action", "${ctx}/admin/houqin/exportElectricityExcel.json");
            jQuery("#searchForm").submit();
            jQuery("#searchForm").prop("action", "${ctx}/admin/houqin/statisticElectricity.json");
        }
...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/houqin/statisticElectricity.json" method="post">
                    ...
                    <div class="disIb ml20 mb10">
                        <span class="vam">&nbsp;&nbsp;用电区域: &nbsp;</span>
                        <label class="vam">
                            <select name="type">
                                <option value="">-请选择-</option>
                                <c:forEach items="${electricityTypeList}" var="eletricity">
                                    <option value="${eletricity.id}" <c:if test="${type==eletricity.id}">selected="selected"</c:if>>${eletricity.type}</option>
                                </c:forEach>
                            </select>
                        </label>
                    </div>
        ...
        <div class="pr">
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <tr>
                    ...
                    <th class="head0 center">用电量(度)</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${naturalStatisticList}" var="statistic">
                    <tr>
                        <td><b>${statistic.month}月</b></td>
                        <td><b>${statistic.degrees}</b></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
