...
<head>
    ...
    <script type="text/javascript">
        function addFormSubmit() {
            ...
            jQuery.ajax({
                url: "${ctx}/admin/houqin/addStorage.json",
        ...
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="addFormSubmit">
                <p>
                    ...
                    <span class="field">
                        <input type="text" name="storage.name" class="longinput" id="name"/>
                    </span>
                </p>
                ...
                <p>
                    ...
                    <span class="field">
                         <input type="text" name="storage.address" class="longinput" id="address"/>
                    </span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>管理员姓名</label>
                    <input type="hidden" name="storage.sysId" class="longinput" id="sysId"/>
                    <input type="hidden" name="storage.managerName"  id="manageNames"/>
                    <span class="field">
                ...
                <p>
                    ...
                    <span class="field">
                         <input type="text" name="storage.managerPhone" class="longinput" id="managerPhone"/>
                    </span>
                </p>
