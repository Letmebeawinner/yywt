...
<div class="centercontent tables">
    <div class="pageheader notab" style="margin-left: 30px">
        <h1 class="pagetitle">批量导入临时住房</h1>
        <span>
            <span style="color:red">说明</span><br>
            1.本页面用于批量导入临时住房<br/>
            2.点击<a href="${ctx}/static/exceltemplate/import_temp_card.xls" style="color:red">下载excel模板</a>,
            参照模板的写法,填写临时住房信息,批量导入.
        </span>
    </div><!--pageheader-->
    <div id="contentwrapper" class="contentwrapper">
        <div id="updates" class="subcontent">
            ...
            <div id="validation" class="subcontent">
                <form id="form1" class="stdform" method="post" action="${ctx}/admin/houqin/batchAddImportTempCard.json"
