...
<head>
    ...
    <script type="text/javascript">
        ...
        function delMenuType(id) {
            ...
            jQuery.ajax({
                    url: "${ctx}/admin/houqin/delMenuType.json",
                    data: {"id": id},
                    type: "post",
                    dataType: "json",
...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/houqin/queryAllMenuType.json" method="post">
                ...
                <div class="disIb ml20 mb10">
                    ...
                    <a href="${ctx}/admin/houqin/toAddMenuType.json"  class="stdbtn ml10">添加类型</a>
                </div>
            </div>
        </div>
        <!-- 搜索条件，结束 -->
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <c:forEach items="${menuTypeList}" var="type">
                    <tr>
                        ...
                        <td>${type.sort}</td>
                        <td class="center">
                            <a href="${ctx}/admin/houqin/toUpdateMenuType/${type.id}.json" class="stdbtn" title="编辑">编辑</a>
