...
<head>
    ...
    <script type="text/javascript">
        function addFormSubmit() {
            ...
            jQuery.ajax({
                url: "${ctx}/admin/houqin/updateWareHouse.json",
    ...
    <script type="text/javascript">
        ...
        function addSystemUser() {
            jQuery.ajax({
                type: "post",
                url: "/admin/houqin/wareHouseGetSystemUserList.json",
                data: data,
                dataType: "text",
                async: false,
                success: function (result) {
            ...
            <form class="stdform stdform2" method="post" action="" id="addFormSubmit">
                <p>
                    ...
                    <span class="field">
                        ...
                        <input type="text" name="wareHouse.name" class="longinput" value="${wareHouse.name}" id="name"/>
                    </span>
                </p>
                ...
                <p>
                    ...
                    <span class="field">
                         <input type="text" name="wareHouse.address" class="longinput" value="${wareHouse.address}" id="address"/>
                    </span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>管理员姓名</label>
                    <input type="hidden" name="wareHouse.sysId" class="longinput" id="sysId" value="${wareHouse.sysId}"/>
                    <input type="hidden" name="wareHouse.managerName"  id="manageNames" value="${wareHouse.managerName}"/>
                    <span class="field">
                         <a href="javascript:void(0)"  onclick="addSystemUser();return false;"  class="stdbtn btn_orange">选择管理员</a>
                        <font id="managerName">${wareHouse.managerName}</font>
                    </span>
                </p>
                ...
                <p>
                    ...
                    <span class="field">
                         <input type="text" name="wareHouse.managerPhone" class="longinput" value="${wareHouse.managerPhone}" id="managerPhone"/>
                    </span>
                </p>
