...
<head>
            ...
            if (confirm("确定删除这个报修吗？")) {
                jQuery.ajax({
                    ...
                    success: function (result) {
                        if (result.code == "0") {
                            window.location.href = "/admin/houqin/queryHqRepairList.json";
                        } else {
    ...
    <script type="text/javascript">
        ...
        function repairExport() {
            ...
            jQuery("#searchForm").submit();
            jQuery("#searchForm").prop("action", "/admin/houqin/queryHqRepairList.json");
        }
...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/houqin/queryHqRepairList.json" method="post">
