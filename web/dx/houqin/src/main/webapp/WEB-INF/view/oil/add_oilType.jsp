...
<head>
    ...
    <script type="text/javascript">
        function addFormSubmit() {
            ...
            jQuery.ajax({
                url: "${ctx}/admin/houqin/addOilType.json",
        ...
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="addFormSubmit">
                <p>
                    ...
                    <span class="field">
                        <input type="text" name="oilType.name" class="longinput" id="name"/>
                    </span>
                </p>
                ...
                <p>
                    ...
                    <span class="field">
                        <input type="text" name="oilType.sort" class="longinput" id="sort" value="0"/>
                    </span>
                </p>
