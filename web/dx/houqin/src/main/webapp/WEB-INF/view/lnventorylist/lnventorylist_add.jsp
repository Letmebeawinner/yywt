...
<head>
    ...
    <script type="text/javascript">
        function addFormSubmit() {
            ...
            jQuery.ajax({
                url: "${ctx}/admin/houqin/addLnventorylist.json",
    ...
    <div id="contentwrapper" class="contentwrapper">
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="addFormSubmit">
                <input type="hidden" name="lnventorylist.meetingId" class="longinput" value="${meetingId}" id="meetingId"/>
                <p>
                    <label><em style="color: red;">*</em>设备设施名称</label>
                    <span class="field">
                        <input type="text" name="lnventorylist.name" class="longinput" id="name"/>
                    </span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>规格型号</label>
                    <span class="field">
                        <input type="text" name="lnventorylist.type" class="longinput" id="type"/>
                    </span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>单位</label>
                    <span class="field">
                        <input type="text" name="lnventorylist.unit" class="longinput" id="unit"/>
                    </span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>数量</label>
                    <span class="field">
                        <input type="text" name="lnventorylist.count" class="longinput" id="count"/>
                    </span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>验收状态</label>
                    <span class="field">
                        <input type="text" name="lnventorylist.ysStatus" class="longinput" id="ysStatus"/>
                    </span>
                </p>
