...
<div class="centercontent tables">
    <div class="pageheader notab" style="margin-left: 30px">
        <h1 class="pagetitle">批量导入用电量</h1>
        <span>
            <span style="color:red">说明</span><br>
            1.本页面用于批量导入用电量<br/>
            2.可下载excel模板,参照模板说明,填写用电量信息，批量导入用电量。
        </span>
    </div><!--pageheader-->
    <div class="mt20">
        <div class="commonWrap">
            <form action="/admin/houqin/import/electricityImport.json" method="post" id="importO"
                        ...
                        <td>
                            <span class="ml10">
                                ...
                                <form>
                                    ...
                                    <input type="reset" onclick='window.location.href="${ctx}/用电量导入模板.xls"' title="下载模板" value="下载模板" class="reset radius2">
                                </form>
                            </span>
                        </td>
                    </tr>
