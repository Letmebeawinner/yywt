...
<div class="centercontent tables">
    <div class="pageheader notab">
        <h1 class="pagetitle">资产分类列表</h1>
        <div style="margin-left: 20px;">
            <span style="color:red">说明</span><br>
            1.本页面用于资产分类列表查看；<br>
            2.查询：输入查询条件，点击<span style="color:red">搜索</span>；<br>
            3.编辑：点击<span style="color:red">编辑</span>修改资产分类信息；<br>
            4.删除：点击<span style="color:red">删除</span>，删除资产分类；<br>
        </div>
    </div><!--pageheader-->
            ...
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/houqin/queryAllProperty.json" method="post">
                    ...
                    <div class="disIb ml20 mb10">
                        <span class="vam">资产名称 &nbsp;</span>
                        <label class="vam">
                            <input style="width: auto;" name="property.typeName" type="text" class="hasDatepicker" value="${property.typeName}" placeholder="输入资产名称">
                        </label>
                    </div>
                </form>
                <div class="disIb ml20 mb10">
                    ...
                    <a href="${ctx}/admin/houqin/toAddProperty.json"  class="stdbtn ml10">添 加</a>
                </div>
            </div>
        </div>
        <!-- 搜索条件，结束 -->
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <c:forEach items="${propertyList}" var="property">
                    <tr>
                        ...
                        <td>${property.sort}</td>
                        <td class="center">
                            <a href="${ctx}/admin/houqin/toUpdateProperty.json?id=${property.id}" class="stdbtn" title="编辑">编辑</a>
