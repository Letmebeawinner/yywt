...
<head>
    ...
    <script type="text/javascript">
        function addFormSubmit() {
            ...
            jQuery.ajax({
                url: "${ctx}/admin/houqin/addElectricityType.json",
        ...
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="addFormSubmit">
                ...
                <p>
                    ...
                    <span class="field">
                        <input type="text" name="electricityType.type"  class="longinput" id="type" maxlength="20"/>
                    </span>
                </p>
