            ...
            jQuery(function () {
                jQuery('#container').highcharts({
                    ...
                    series: [{
                        ...
                        name: '用水量占比',
                        data: [
                            <c:forEach items="${waterStatisticList}" var="water" varStatus="index">
                            <c:if test="${!index.last}">
                            ['${water.type}', ${water.amount}],
                            </c:if>
                            <c:if test="${index.last}">
                            ['${water.type}', ${water.amount}]
                            </c:if>
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5" style="width: 45%; float: left">
                <form class="disIb" id="searchForm" action="${ctx}/admin/houqin/statisticByWaterPurpose.json"
                      method="post">
            ...
            <div class="fl mt5" style="width: 45%; float: right">
                ...
                <label class="vam">
                    <select name="month" id="compareA">
                        <option value="">请选择</option>
                        <c:forEach items="${waterStatisticList}" var="water">
