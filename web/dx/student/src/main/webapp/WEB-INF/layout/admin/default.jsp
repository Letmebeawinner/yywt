...
<title><sitemesh:write property='title'/>-鏅烘収鏍″洯绠＄悊骞冲彴</title>
        ...
        <div class="right">
            ...
            <div class="userinfodrop">
                <div class="userdata" style="margin-left: 0px;">
                    ...
                    <ul>
                        <li><a href="${basePath}/admin/index.json">杩斿洖鍒囨崲瀛愮郴缁�</a></li>
                        <li><a href="javascript:goToMessage('${basePath}','${smsPath}');">娑堟伅</a></li>
                        <li><a href="${basePath}/admin/base/sysuser/toUpdateThisSysUser.json">璐﹀彿璁剧疆</a></li>
                        <li><a href="${basePath}/admin/outLogin.json">閫�鍑�</a></li>
                    </ul>
                </div><!--userdata-->
            </div><!--userinfodrop-->
        </div><!--right-->
