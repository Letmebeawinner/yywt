        ...
        <div class="pr">
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <c:if test="${userList!=null&&userList.size()>0 }">
                    <c:set var="startNum"  scope="session" value="0"/>
                    <c:forEach items="${userMap}" var="item">
                        ...
                        <c:forEach items="${item.value}" var="user" varStatus="index">
                            <tr>
                                <td <c:if test="${user.politicalStatus!=0}">style="color:red;"</c:if>>${startNum+1}</td>
                            ...
                            <c:set var="startNum"  scope="session" value="${startNum+1}"/>
                        </c:forEach>
