	...
	<body>
	    <div class="centercontent tables">
	         <div class="pageheader notab" style="margin-left: 30px">
                <h1 class="pagetitle">新建党性分析材料</h1>
                <span>
                    <span style="color:red">说明</span><br>
                    1.本页面用于新建党性分析材料<br />
                    2.按要求填写相关信息,点击"提交"按钮,新建党性分析材料.<br />
                    ...
                    <input type="hidden" id="meetingName" name="materialAnalysis.meetingName" />
                    	<p>
                            ...
                            <select name="materialAnalysis.type" id="type">
                               	<option value="train">培训党性分析材料</option>
                                <option value="meeting">会议党性分析材料</option>
                            </select>
                            </span>
                        </p>
                        ...
                        <p class="stdformbutton">
                        	<button class="radius2" onclick="addMaterialAnalysis();" id="submitButton" style="background-color: #d20009;border-color: #de4204;cursor: pointer;font-weight: bold;padding: 7px 10px;color: #fff;margin-left: 220px;">
                        	提交
                        	</button>
                        </p>
