        ...
        <div class="pr">
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <tr>
                    ...
                    <th class="head1 center">评价内容</th>
                    <th class="head1 center">操作</th>
                </tr>
                </thead>
                <tbody>
                <c:if test="${courseArrangeEvaluateRecordList!=null&&courseArrangeEvaluateRecordList.size()>0 }">
                    <c:forEach items="${courseArrangeEvaluateRecordList}" var="courseArrangeEvaluateRecord" varStatus="index">
                        <tr>
                            <td>${index.index+1}</td>
                            <td>${courseArrangeEvaluateRecord.userName}</td>
                            <td>${courseArrangeEvaluateRecord.courseName}</td>
                            <td>${courseArrangeEvaluateRecord.courseTime}</td>
                            <td>${courseArrangeEvaluate.content}</td>
                            <td class="center">
                            </td>
                        </tr>
                    </c:forEach>
