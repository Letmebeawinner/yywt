...
<div class="tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/jiaowu/user/userListOfOneClassForSelect.json"
                      method="get">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <c:if test="${userList!=null&&userList.size()>0 }">
                    <c:forEach items="${userList}" var="user">
                        <tr>
                            <td><input type="radio" name="userId" value="${user.id}-${user.name}"
                                       class="questionIds"/>${user.id}</td>
