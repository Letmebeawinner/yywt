				...
				<div id="validation" class="subcontent">
                    ...
                    <input type="hidden" value="${courseType.id}" id="id" name="courseType.id"/>
                        <p>
                            ...
                            <span class="field"><input type="text" name="courseType.name" id="name" class="longinput" value="${courseType.name}"/></span>
                        </p>
                        <br />
                    </form>
					<p class="stdformbutton">
                        	<button class="radius2" onclick="updateCourseType()" id="submitButton" style="background-color: #d20009;border-color: #de4204;cursor: pointer;font-weight: bold;padding: 7px 10px;color: #fff;margin-left: 220px;">提交</button>
                        </p>
            </div>
            <!-- 主要内容结束 -->
				<div class="clear"></div>
