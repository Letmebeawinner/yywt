...
<div class="tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/jiaowu/user/userListForSelect.json" method="get">
                    <div class="disIb ml20 mb10">
                        <span class="vam">姓名 &nbsp;</span>
                        <label class="vam">
                            <input id="studentName" style="width: auto;" name="studentName" type="text" class="hasDatepicker" value="${user.name}" placeholder="请输入姓名">
                        </label>
                    </div>
                </form>
                <div class="disIb ml20 mb10">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <c:if test="${userList!=null&&userList.size()>0 }">
                    <c:forEach items="${userList}" var="user">
                        <tr>
                            <td width="60px"><input type="radio" name="userId" value="${user.id}-${user.name}-${user.studentId}" class="questionIds" />${user.id}</td>
