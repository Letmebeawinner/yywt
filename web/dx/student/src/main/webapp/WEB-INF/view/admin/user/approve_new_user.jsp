...
<%-- 		<script type="text/javascript" src="${ctx}/static/js/custom/elements.js"></script> --%>
        ...
        function approveNewUser(){
        	...
        	jQuery.ajax({
	    		url:'${ctx}/admin/jiaowu/user/approveNewUser.json',
	    		data:{"id":id},
	    		type:'post',
	    		dataType:'json',		
	...
	<body>
	    <div class="centercontent tables">
	         <div class="pageheader notab" style="margin-left: 30px">
                <h1 class="pagetitle">审批新生</h1>
                <span>
                    <span style="color:red">说明</span><br>
                    1.本页面用于审批新生<br />
                    2.可查看某位学员的信息,点击"审批通过"按钮,从而审批通过某位新生.或点击"返回"按钮,返回上一页面.
				</span>
             </div><!--pageheader-->
				...
				<div id="validation" class="subcontent">
                    ...
                    <input type="hidden" id="userId" name="user.id" />
                        ...
                        <p class="stdformbutton">
                        	<button class="radius2" onclick="approveNewUser()" id="submitButton" style="background-color: #d20009;border-color: #de4204;cursor: pointer;font-weight: bold;padding: 7px 10px;color: #fff;margin-left: 220px;">
                        	审批通过
                        	</button>
