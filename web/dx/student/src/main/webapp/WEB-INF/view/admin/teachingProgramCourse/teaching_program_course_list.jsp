	    ...
	    <div class="centercontent tables">
	         <div class="pageheader notab" style="margin-left: 30px">
                ...
                <span>
					...
					1.本页面展示教学计划课程的列表.<br />
					2.可通过课程、班级和讲师查询对应的教学计划课程.<br />
					3.如果某教学计划课程所属的教学计划未确认,可点击"修改"按钮,修改教学计划课程.<br />
					4.如果某教学计划课程所属的教学计划未确认,可点击"删除"按钮,删除教学计划课程.<br />
                </span>
             </div><!--pageheader-->
                    ...
                    <div class="fl mt5">
                        <form class="disIb" id="searchForm" action="${ctx}/admin/jiaowu/teach/teachingProgramCourseList.json" method="get">
                            ...
                            <div class="tableoptions disIb mb10">
                                ...
                                <a href="javascript:void(0)" onclick="selectCourse()" class="stdbtn btn_orange">选择课程</a>
                                </label>
                            </div>
...
<!--                                 <th class="head1 center">状态</th> -->
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${teachingProgramCourseList}" var="teachingProgramCourse" varStatus="index">
                            <tr>
                                <td>${index.index+1}</td>
                                <td>${teachingProgramCourse.courseName}</td>
                                <td>${teachingProgramCourse.className}</td>
                                <td>${teachingProgramCourse.teacherName}</td>
                                <td>${teachingProgramCourse.classroomName}</td>
<%--                                 <td>${teachingProgramCourse.status}</td> --%>
                                ...
                                <td class="center">
                                    ...
                                    <a href="javascript:void(0)" onclick="deleteTeachingProgramCourse(${teachingProgramCourse.id})" class="stdbtn" title="删除">删除</a>
                                	</c:if>
                                </td>
                            </tr>
                            </c:forEach>
