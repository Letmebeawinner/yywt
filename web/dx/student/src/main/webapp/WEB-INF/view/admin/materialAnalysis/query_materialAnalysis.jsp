...
<html>
	<head>
		<title>查询党性分析材料</title>
	</head>
	<body>
	    <div class="centercontent tables">
	         <div class="pageheader notab" style="margin-left: 30px">
                <h1 class="pagetitle">查询党性分析材料</h1>
                <span>
                    <span style="color:red">说明</span><br>
                    1.本页面用于展示某党性分析材料的具体内容<br />
				</span>
             </div><!--pageheader-->
				...
				<div id="validation" class="subcontent">
                    ...
                    <form id="form1" class="stdform" method="post" action="">
                        ...
                        <p>
                            ...
                            <input type="text" name="classes.name" id="name" class="longinput" readonly="readonly" value="培训党性分析材料"/>
                            </c:if>
                            <c:if test='${materialAnalysis.type=="meeting"}'>
                            <input type="text" name="classes.name" id="name" class="longinput" readonly="readonly" value="会议党性分析材料"/>
                            </c:if>
