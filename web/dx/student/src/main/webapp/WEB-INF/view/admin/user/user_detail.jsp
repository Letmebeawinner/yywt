                ...
                <div id="validation" class="subcontent">
                    <div class="tables-all">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <tt style="line-height: 31px;width:100px;display: inline-block;">报送人姓名</tt>
                                </td>
                                <td colspan="2">
                                  <span class="field">${user.submittedName}</span>
                                </td>
                                <td colspan="1" style="width: 100px;">
                                    <tt style="line-height: 31px;width:100px;display: inline-block;">报送人手机号</tt>
                                </td>
                                <td colspan="2">
                                   <span class="field">${user.submittedMobile}</span>
                                </td>
