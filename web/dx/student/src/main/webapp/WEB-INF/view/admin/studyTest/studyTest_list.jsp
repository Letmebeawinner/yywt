            ...
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/jiaowu/studyTest/studyTestList.json" method="get">
                    <div class="disIb ml20 mb10">
                        ...
                        <label class="vam">
                            <input id="name" style="width: auto;" name="name" type="text" class="hasDatepicker" value="${studyTest.name}" placeholder="请输入姓名">
                        </label>
                    </div>
                ...
                <div class="disIb ml20 mb10">
                    ...
                    <c:if test="${!isStudent}">
                    <a href="${ctx}/admin/jiaowu/studyTest/toAddBatchStudyTest.json" class="stdbtn ml10">批量导入</a>
                    </c:if>
                </div>
            </div>
        </div>
        ...
        <div class="pr">
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <tr>
                    ...
                    <th class="head0 center"  rowspan="2">学员姓名</th>
