            ...
            <div id="validation" class="subcontent">
                ...
                <form id="form1" class="stdform stdform2" method="post" action="">
                    <p>
                        ...
                        <span class="field"><input type="text" name="research.title" id="title"
                                                   class="longinput"/></span>
                    </p>
                    <p>
                        <label><em style="color: red;">*</em>开始时间</label>
                        <span class="field">
                            	<input type="text" class="some_class" value="" id="startTime" name="research.startTime"/>
                            </span>
                    </p>
                    <p>
                        <label><em style="color: red;">*</em>结束时间</label>
                        <span class="field">
                            	<input type="text" class="some_class" value="" id="endTime" name="research.endTime"/>
                            </span>
                    </p>
                    <p>
                        <label>备注</label>
                        <span class="field">
                            <textarea cols="80" rows="5" name="research.note" class="mediuminput" id="note"></textarea></span>
                    </p>
                    <br/>

                </form>
                <p class="stdformbutton">
                    <button class="radius2" onclick="addResearch()" id="submitButton"
