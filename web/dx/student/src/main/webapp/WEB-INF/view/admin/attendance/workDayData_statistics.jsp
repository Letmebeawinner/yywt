            ...
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/jiaowu/attendance/workDayDataStatistics.json" method="get">
                    ...
                    <div class="disIb ml20 mb10">
                        ...
                        <label class="vam">
                            <input id="startTime" type="text" name="userCondition.startTime"  readonly value="<fmt:formatDate type='both' value='${userCondition.startTime}' pattern='yyyy-MM-dd'/>"/>
                        </label>
                    </div>
                        <div class="disIb ml20 mb10">
                            <span class="vam">结束日期 &nbsp;</span>
                            <label class="vam">
                                <input id="endTime" type="text"  name="userCondition.endTime" readonly value="<fmt:formatDate type='both' value='${userCondition.endTime}' pattern='yyyy-MM-dd'/>"/>
                        </label>
                        </div>
                </form>
                <div class="disIb ml20 mb10">
        ...
        <div class="pr">
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <tr>
                    ...
                    <th class="head1 center">旷课天数</th>
                    <th class="head1 center">请假天数</th>
