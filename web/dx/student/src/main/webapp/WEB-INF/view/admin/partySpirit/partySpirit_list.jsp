            ...
            <div class="fl mt5">
                <form class="disIb" id="searchForm" action="${ctx}/admin/jiaowu/partySpirit/partySpiritList.json" method="get">
                    <div class="disIb ml20 mb10">
                        ...
                        <label class="vam">
                            <input id="name" style="width: auto;" name="name" type="text" class="hasDatepicker" value="${partySpirit.name}" placeholder="请输入姓名">
                        </label>
                    </div>
                ...
                <div class="disIb ml20 mb10">
                    ...
                    <a href="${ctx}/admin/jiaowu/partySpirit/toAddBatchPartySpirit.json" class="stdbtn ml10">批量导入</a>
                </div>
            </div>
        </div>
        <!-- 搜索条件，结束 -->
