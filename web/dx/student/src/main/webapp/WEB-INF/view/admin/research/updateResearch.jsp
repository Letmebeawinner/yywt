				...
				<div id="validation" class="subcontent">
                    ...
                    <form id="form1" class="stdform" method="post" action="">
                        ...
                        <p>
                            ...
                            <span class="field">
                            	<input id="startTime" type="text" class="longinput" name="research.startTime" readonly="readonly" value="<fmt:formatDate type='both' value='${research.startTime}' pattern='yyyy-MM-dd HH:mm:ss'/>"/>
                            </span>
                        </p> 
                        <p>
                        	<label><em style="color: red;">*</em>结束时间</label>
                            <span class="field">
                            	<input id="endTime" type="text" class="longinput"  name="research.endTime" readonly="readonly" value="<fmt:formatDate type='both' value='${research.endTime}' pattern='yyyy-MM-dd HH:mm:ss'/>"/>
                            </span>
                        </p>
                        <p>
                        	<label>备注</label>
