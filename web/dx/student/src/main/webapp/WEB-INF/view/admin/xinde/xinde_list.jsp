                ...
                <div class="overviewhead clearfix mb10">
                    <div class="fl mt5">
                        ...
                        <div class="disIb ml20 mb10">
                            ...
                            <a href="${ctx}/admin/jiaowu/xinDe/toCreateXinDe.json" class="stdbtn btn_orange">添加</a>
                        </div>
                    </div>
                </div>
                <!-- 搜索条件，结束 -->
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <%--<a href="${ctx}/admin/jiaowu/xinDe/queryXinDe.json?id=${xinDe.id}" class="stdbtn" title="修改">查看</a>--%>
