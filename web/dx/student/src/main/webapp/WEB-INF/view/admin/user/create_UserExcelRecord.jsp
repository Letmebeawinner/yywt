        ...
        function addFormSubmit() {
            jQuery.ajax({
                ...
                success: function (result) {
                    if (result.code == "0") {
                        window.location.href = "${ctx}/admin/jiaowu/user/userExcelRecordList.json";
                    } else {
...
<div class="centercontent">
    <div class="pageheader" style="margin-left: 30px">
        ...
        <span>
                    ...
                    3.带有红色<span style="color: red">*</span>标记的内容为必填部分。<br/>
                    4.<a href="${ctx}/static/common/new_user_list_model1.xls" style="color: red;">下载学员名单模板</a>
		</span>
    </div>
            ...
            <form class="stdform stdform2" method="post" action="" id="addFormSubmit">
                ...
                <p>
                    <label><em style="color: red;">*</em>文件地址:</label>
					 <span class="field">
						 <input type="text" name="userExcelRecord.url"   id="fileUrl" class="longinput" />
                ...
                <p class="stdformbutton" style="text-align: center">
                    <button class="radius2" onclick="addFormSubmit();return false;" id="submitButton">
                        提交
                    </button>
                </p>
            </form>
