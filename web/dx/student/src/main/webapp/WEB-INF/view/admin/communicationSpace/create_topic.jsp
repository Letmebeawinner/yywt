...
<%-- 		<script type="text/javascript" src="${ctx}/static/js/custom/elements.js"></script> --%>
        ...
        function addTopic(){
        	...
        	jQuery.ajax({
	    		url:'${ctx}/admin/jiaowu/topic/createTopic.json',
	    		data:params,
	    		type:'post',
	    		dataType:'json',		
	    		success:function (result){
	    			if(result.code=="0"){
	    				window.location.href="${ctx}/admin/jiaowu/topic/topicList.json";
	    			}else{
	...
	<body>
	    <div class="centercontent tables">
	         <div class="pageheader notab" style="margin-left: 30px">
                <h1 class="pagetitle">新建话题</h1>
                <span>
                    <span style="color:red">说明</span><br>
                    1.本页面用于新建话题<br />
                    2.按要求填写相关信息,点击"提交"按钮,新建话题.<br />
				...
				<div id="validation" class="subcontent">
                    <form id="form1" class="stdform" method="post" action="">
                        <p>
                            ...
                            <span class="field"><input type="text" name="topic.title" id="title" class="longinput" /></span>
                        </p>
                        <p>
                        	<label><em style="color: red;">*</em>内容</label>
                            <span class="field"><textarea cols="80" rows="5" name="topic.content" class="mediuminput" id="content"></textarea></span> 
                        </p>
                        <br />
                    </form>
                        <p class="stdformbutton">
                        	<button class="radius2" onclick="addTopic()" id="submitButton" style="background-color: #d20009;border-color: #de4204;cursor: pointer;font-weight: bold;padding: 7px 10px;color: #fff;margin-left: 220px;">
                        	提交
                        	</button>
                        </p>
