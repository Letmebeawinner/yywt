...
<head>
    ...
    <script type="text/javascript">
        ...
        function updateActivity(){
            ...
            jQuery.ajax({
                url:'${ctx}/admin/jiaowu/activity/updateActivity.json',
                data:params,
                type:'post',
                dataType:'json',
...
<div class="centercontent tables">
    <div class="pageheader notab" style="margin-left: 30px">
        <h1 class="pagetitle">修改活动</h1>
            <span>
            <span style="color:red">说明</span><br>
            1.本页面用于修改活动<br />
    2.按要求填写相关信息,点击"提交"按钮,修改活动.<br />
            ...
            <div id="validation" class="subcontent">
                <form id="form1" class="stdform" method="post" action="">
                    ...
                    <p>
                        ...
                        <span class="field"><input type="text" name="activity.title" id="title" class="longinput" value="${activity.title}"/></span>
                    </p>
                    <p>
                        <label><em style="color: red;">*</em>内容</label>
                        <span class="field"><textarea cols="80" rows="5" name="activity.content" class="mediuminput" id="content">${activity.content}</textarea></span>
                    </p>
                    <br />
                </form>
                <p class="stdformbutton">
                    <button class="radius2" onclick="updateActivity()" id="submitButton" style="background-color: #d20009;border-color: #de4204;cursor: pointer;font-weight: bold;padding: 7px 10px;color: #fff;margin-left: 220px;">
                        提交
                    </button>
                </p>
