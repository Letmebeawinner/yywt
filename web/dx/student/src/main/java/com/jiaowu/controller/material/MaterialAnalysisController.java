...
//				whereSql.append(" and studentId="+userMap.get("linkId"));
				conditionMap.put("studentId",userMap.get("linkId"));
			}
...
//				whereSql.append(" and studentId="+studentId);
				conditionMap.put()
...
//				whereSql.append(" and meetingId="+meetingId);
				conditionMap.put("meetingId",meetingId);
			...
			if(!StringUtils.isTrimEmpty(classTypeId)&&Long.parseLong(classTypeId)>0){
				conditionMap.put("classTypeId",classTypeId);
...
//	        List<MaterialAnalysis> materialAnalysisList = materialAnalysisBiz.find(pagination,whereSql.toString());
			List<MaterialAnalysisDTO> materialAnalysisList=materialAnalysisBiz.getMaterialAnalysisList(conditionMap,pagination);
