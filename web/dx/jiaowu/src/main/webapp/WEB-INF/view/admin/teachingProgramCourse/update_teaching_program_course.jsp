             ...
             <div id="contentwrapper" class="contentwrapper">
				...
				<div id="validation" class="subcontent">
                    ...
                    <form id="form1" class="stdform stdform2" method="post" action="">
                    	<p>
                            <input type="hidden" name="teachingProgramCourse.id" value="${teachingProgramCourse.id}" id="teachingProgramCourseId" />
                            ...
                            <input type="hidden" name="teachingProgramCourse.shiftStartTime" id="shiftStartTime" value="${teachingProgramCourse.shiftStartTime}"/>
                            <input type="hidden" name="teachingProgramCourse.shiftEndTime" id="shiftEndTime" value="${teachingProgramCourse.shiftEndTime}" />
                        ...
                        <p class="stdformbutton" style="text-align: center">
                            <button class="radius2" onclick="updateTeachingProgramCourse();return false;">提交</button>
                        </p>
                    </form>
            </div>
            <!-- 主要内容结束 -->
