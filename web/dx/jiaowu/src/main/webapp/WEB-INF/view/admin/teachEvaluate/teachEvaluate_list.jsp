...
<body>
    <div class="centercontent tables">
        <div class="pageheader notab" style="margin-left: 30px">
            <h1 class="pagetitle">教学质量评估列表</h1>
                    <span>
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div class="overviewhead clearfix mb10">
                <div class="fl mt5">
                    <form class="disIb" id="searchForm" action="${ctx}/admin/jiaowu/teachEvaluate/teachEvaluateList.json" method="get">
                    ...
                    <div class="disIb ml20 mb10">
                        ...
                        <a href="${ctx}/admin/jiaowu/teachEvaluate/teachEvaluateAverageList.json"  class="stdbtn btn_orange">查询讲师平均分</a>
                    </div>
                </div>
            </div>
            <!-- 搜索条件，结束 -->
                        ...
                        <c:forEach items="${teachEvaluateList}" var="teachEvaluate">
                            <tr>
                                ...
                                <td class="center">
                                    ...
                                    <a href="${ctx}/admin/jiaowu/teachEvaluate/toUpdateTeachEvaluate.json?id=${teachEvaluate.id}" class="stdbtn" title="修改">修改</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </c:if>
