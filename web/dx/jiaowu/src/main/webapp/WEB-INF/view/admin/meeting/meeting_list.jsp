                    ...
                    <div class="fl mt5">
                        <form class="disIb" id="searchForm" action="${ctx}/admin/jiaowu/meeting/meetingList.json" method="get">
                           ...
                           <div class="disIb ml20 mb10">
                               ...
                               <label class="vam">
                               <input id="startTime" style="width: auto;height: 35px;" name="startTime" type="text" class="hasDatepicker laydate-icon" value="" placeholder="请输入开始时间" readonly="readonly">
                               </label>
                           </div>
                           <div class="disIb ml20 mb10">
                               <span class="vam">结束时间 &nbsp;</span>
                               <label class="vam">
                               <input id="endTime" style="width: auto;height: 35px;" name="endTime" type="text" class="hasDatepicker laydate-icon" value="" placeholder="请输入结束时间" readonly="readonly">
                               </label>
                           </div>
                        </form>
                        <div class="disIb ml20 mb10">
