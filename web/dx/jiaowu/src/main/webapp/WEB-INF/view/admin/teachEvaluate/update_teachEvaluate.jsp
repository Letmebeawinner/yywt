...
//                index8=0;
        ...
        function updateTeachEvaluate(){
            ...
            jQuery.ajax({
                url:'${ctx}/admin/jiaowu/teachEvaluate/updateTeachEvaluate.json',
    ...
    <div id="contentwrapper" class="contentwrapper page-invitor"><!--contentwrapper-->
        <div id="updates" class="subcontent">
            ...
            <form id="form1" class="stdform" method="post" action="">
                <input type="hidden" name="teachEvaluate.id" value="${teachEvaluate.id}"/>
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="padding: 10px;">
                                    <input type="text" name="teachEvaluate.index1" id="index1" value="${teachEvaluate.index1}" />
                                </td>
                                <td style="padding: 10px;">
                                    <input type="text" name="teachEvaluate.index2" id="index2" value="${teachEvaluate.index2}" />
                                </td>
                                <td style="padding: 10px;">
                                    <input type="text" name="teachEvaluate.index3" id="index3" value="${teachEvaluate.index3}" />
                                </td>
                                <td style="padding: 10px;">
                                    <input type="text" name="teachEvaluate.index4" id="index4" value="${teachEvaluate.index4}" />
                                </td>
                                <td style="padding: 10px;">
                                    <input type="text" name="teachEvaluate.index5" id="index5" value="${teachEvaluate.index5}"/>
                                </td>
                                <td style="padding: 10px;">
                                    <input type="text" name="teachEvaluate.index6" id="index6" value="${teachEvaluate.index6}" />
                                </td>
                                <td style="padding: 10px;">
                                    <input type="text" name="teachEvaluate.index7" id="index7" value="${teachEvaluate.index7}" />
                                </td>
                                <td style="padding: 10px;">
                                    <input type="text" name="teachEvaluate.index8" id="index8" value="${teachEvaluate.index8}" />
                                </td>
                                <td style="padding: 10px;">
                                    <input type="text" name="teachEvaluate.total" id="total"  value="${teachEvaluate.total}"/>
                                </td>
                            </tr>
            ...
            <p class="stdformbutton tac">
                <button class="radius2" onclick="updateTeachEvaluate()" id="submitButton" style="background-color: #d20009;border:1px solid #de4204;width:120px;line-height:28px;font-size:14px;cursor: pointer;font-weight: bold;padding: 7px 10px;color: #fff;margin-top: 30px;">
                    提交
                </button>
