             ...
             <div id="contentwrapper" class="contentwrapper">
				...
				<div id="validation" class="subcontent">
                    ...
                    <form id="form1" class="stdform" method="post" action="">
                    	<input type="hidden" name="classroom.compereId" id="compereId"/>
						<p>
                        ...
                        <p class="stdformbutton">
                        	<button class="radius2" onclick="addClassroom()" id="submitButton" style="background-color: #d20009;border-color: #de4204;cursor: pointer;font-weight: bold;padding: 7px 10px;color: #fff;margin-left: 220px;">
                        	提交
                        	</button>
                        </p>
