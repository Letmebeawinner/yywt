...
<head>
    ...
    <div id="contentwrapper" class="contentwrapper">
            ...
            <span class="field">
            <input id="startTime" type="text" class="width100 laydate-icon" style="width: 240px;" name="classes.startTime" value="<fmt:formatDate value='${registerDeadline.deadline}' pattern='yyyy-MM-dd HH:mm:ss'></fmt:formatDate>"/>
            </span>
            </p>
            <br />
