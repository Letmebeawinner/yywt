...
<head>
    ...
    <script type="text/javascript">
        ...
        function updateCourseArrange(){
            ...
            var discussName=jQuery("#discussName").val();
            jQuery.ajax({
                ...
                data:{
                    ...
                    "otherClassIds":str,
                    "courseArrange.discussId":discussId,
                    "courseArrange.discussName":discussName,
                },
                type:'post',
                dataType:'json',
        ...
        function addClassId(classId,className){
            ...
            jQuery("#classroomspan").html(className+"<a href='javascript:void(0);' onclick='quxiao(1)' style='color: red;'>取消</a>");
        }
        ...
        <div id="updates" class="subcontent">
            ...
            <div id="validation" class="subcontent">
                ...
                <form id="form1" class="stdform" method="post" action="">
                    ...
                    <input type="hidden" id="discussId" name="courseArrange.discussId" value="${courseArrange.discussId }"/>
                    <input type="hidden" id="discussName" name="courseArrange.discussName" value="${courseArrange.teacherName }"/>
                    <p>
                        <label>课程名称</label>
                    ...
                    <p>
                        <label>讨论室</label>
                        <span class="field">
                            <span id="discussspan">${courseArrange.discussName}</span>
