        ...
        function emptyForm(){
			...
			function tijiao(){
				...
				qstChecked.each(function() {
					...
					myArrayMoveStock.push(classIdAndName.split("-")[2]);
					myArrayMoveStock.push(classIdAndName.split("-")[3]);
...
<!--                                 <th class="head1 center">操作</th> -->
                        ...
                        <tbody>
                            ...
                            <tr>
                            	<td><input name="classId" type="radio" value="${classes.id}-${classes.name}-${classes.startTime}-${classes.endTime}" class="questionIds" />${classes.id }</td>
