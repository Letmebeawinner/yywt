...
<%--         <script type="text/javascript" src="${ctx}/static/admin/js/resource-list.js"></script> --%>
        ...
        jQuery(function(){
        	...
        	var teacherId= "${courseArrange.teacherId}";
	...
	<body>
	    <div class="centercontent tables">
	         <div class="pageheader notab" style="margin-left: 30px">
                <h1 class="pagetitle">讲师上课列表</h1>
                <span>
                    <span style="color:red">说明</span><br>
					1.本页面用来展示讲师所有的上课记录.<br>
					2.可通过开始时间和结束时间来查询对应的上课记录.<br>
                </span>
             </div><!--pageheader-->
             <div id="contentwrapper" class="contentwrapper">
                ...
                <div class="overviewhead clearfix mb10">
                    <div class="fl mt5">
                        <form class="disIb" id="searchForm" action="${ctx}/admin/jiaowu/courseArrange/teacherActivity.json" method="get">                            
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="head1 center">班级</th>
                                 <th class="head1 center">教室</th>
                            </tr>
                        </thead>
                        <tbody>
