...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="postForm" action="${ctx}/admin/jiaowu/ky/myTaskResultList.json?resultType=1"
                      method="post">
                ...
                <div class="disIb ml20 mb10">
                    <a href="${ctx}/admin/jiaowu/ky/awardDeclaration.json"
                       class="stdbtn ml10 btn_orange">新建获奖申报</a>
                    <a href="${ctx}/admin/jiaowu/ky/myAwardDeclaration.json"
                    ...
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <c:if test="${result.passStatus==6 or result.passStatus==9}">
                                <a href="${ctx}/admin/jiaowu/ky/toAddResult.json?result.resultForm=3&result.resultType=${resultType}"
                            ...
                            <c:if test="${result.passStatus==7 and empty result.fileUrlDeclaration}">
                                ...
                                <a href="${ctx}/admin/jiaowu/ky/getResultInfo.json?id=${result.id}" class="stdbtn" title="查看">查看</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
