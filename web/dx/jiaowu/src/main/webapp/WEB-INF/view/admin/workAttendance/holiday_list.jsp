                ...
                <c:if test="${holidayList!=null&&holidayList.size()>0 }">
                    <c:forEach items="${holidayList}" var="holiday" varStatus="index">
                        <tr>
                            ...
                            <td><fmt:formatDate type="both" value="${holiday.beginTime}" pattern="yyyy-MM-dd HH:mm"/></td>
                            ...
                            <td class="center">
                                ...
                                <c:if test="${holiday.status==2}">
                                    ...
                                    <a href="javascript:void(0)" onclick="pass(${holiday.id})" class="stdbtn" title="批准">批准</a>
                                    <a href="javascript:void(0)" onclick="deny(${holiday.id})" class="stdbtn" title="不批准">不批准</a>
                                    </span>
                                </c:if>
                            </td>
                        </tr>
