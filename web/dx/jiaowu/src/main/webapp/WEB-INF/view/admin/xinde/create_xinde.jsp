            ...
            <div id="validation" class="subcontent">
                ...
                <form id="form1" class="stdform stdform2" method="post" action="">
                    ...
                    <p>
                        ...
                        <span class="field"><textarea cols="80" rows="5" name="xinDe.content" class="mediuminput"
                                                      id="content"></textarea></span>
                    </p>
                    <p>
                        <label>备注</label>
                        <span class="field"><textarea cols="80" rows="5" name="xinDe.note" class="mediuminput"
                                                      id="note"></textarea></span>
                    </p>

                    <p class="stdformbutton" style="text-align: center">
                        <button class="radius2" onclick="addXinDe(); return false" id="submitButton">提交</button>
                    </p>
                </form>
            </div>
            <!-- 主要内容结束 -->
