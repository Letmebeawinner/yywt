...
//            alert(nameArray);
        ...
        function zuoqutuExcel(){
            ...
            /*jQuery("#classIdExcel").val(jQuery("#classes").val());
            jQuery("#className").val(jQuery("#classes").text());
            jQuery("#classroomId").val(jQuery("#classroom").val());*/
        ...
        <div class="testtle-tables">
            ...
            <table border="1">
                <tr >
                    ...
                    <td rowspan="10"  class="vertical"><tt>过</tt></td>
