...
<head>
    ...
    <script type="text/javascript">
        ...
        function addFormSubmit() {
            ...
            jQuery.ajax({
                url: "${ctx}/admin/jiaowu/excel/add.json",
...
<div class="centercontent">
    <div class="pageheader">
        <h1 class="pagetitle">上传动态教学文件</h1>
    </div>
    ...
    <div id="contentwrapper" class="contentwrapper">
        <div id="basicform" class="subcontent">
            ...
            <form class="stdform stdform2" method="post" action="" id="updateFormSubmit">
                <input type="hidden" name="uploadExcelHistory.fileName" id="fileName" />
                <p>
                    <label><em style="color: red;">*</em>文件标题</label>
                    <span class="field">
                        <input type="text" name="uploadExcelHistory.title" id="title" class="longinput"/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>上传Excel:</label>
                    <span class="field">
                             <input type="hidden" name="uploadExcelHistory.fileUrl" id="fileUrl"/>
