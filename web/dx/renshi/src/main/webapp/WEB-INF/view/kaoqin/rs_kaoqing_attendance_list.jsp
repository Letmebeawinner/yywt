...
<div class="centercontent">
    <div class="pageheader" style="margin-left: 10px">
        ...
        <div class="work-title">
            <form action="${ctx}/admin/rs/queryAttendanceList.json" method="post" id="attendanceFrom">
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                   
                    <tr>
                        <c:if test="${checkWorkAttendance.roleId ==46 || checkWorkAttendance.roleId ==10 || checkWorkAttendance.roleId ==104}">
                            <td width="10%">部&nbsp;门:</td>
                            <td width="20%">
                ...
                <tr>
                    ...
                    <td width="23.4%">
                        <c:if test="${checkWorkAttendance.attendanceName!=null && ''!=checkWorkAttendance.attendanceName}">
                            ${checkWorkAttendance.attendanceName}
                        </c:if>
                    </td>
                </tr>
            </table>
                        ...
                        <c:forEach items="${dataMap.get(am)}" var="amCkad">
                            ...
                            <td align="center">
                                <c:choose>
                                    ...
                                    <c:when test="${amCkad.amAttendanceStatus==9}">
                                        ∆
                                    </c:when>
                        ...
                        <c:forEach items="${dataMap.get(pm)}" var="pmCkad">
                            <td align="center">
                                <c:choose>
                                    ...
                                    <c:when test="${pmCkad.pmAttendanceStatus==9}">
                                        ∆
                                    </c:when>
                                    <c:otherwise>-</c:otherwise>
                                </c:choose>
