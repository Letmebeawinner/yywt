    ...
    <div id="contentwrapper" class="contentwrapper">
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="addinstitution">
                <p>
                    <input type="hidden" name="institution.employeeId" id="employeeId" class="longinput"/>
                ...
                <p>
                    ...
                    <span class="field">
                        <input type="radio" name="institution.isCertificate" checked="checked" value="0"
                               onclick="isCertificate('0')"/>是&nbsp;&nbsp;
                        <input type="radio" name="institution.isCertificate" value="1" onclick="isCertificate('1')"/>否&nbsp;
                    </span>
                </p>
...
<script type="text/javascript">
    ...
    function addFormSubmit() {
        ...
        if (jQuery("#certificateTime").val() == "") {
            jQuery("#certificateTime").val(getCurrentDate())
        }
        console.log(jQuery("#addinstitution").serialize())
        jQuery.ajax({
