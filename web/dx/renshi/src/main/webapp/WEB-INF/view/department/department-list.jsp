    ...
    <div class="contentwrapper">
        ...
        <div id="basicform" class="subcontent" style="display: table-cell; width: 60%">
            <form id="form" class="stdform stdform2" action="#">
                ...
                <p>
                    <label for="departmentName"><em style="color: red;">*</em>部门名称</label>
                    <span class="field"><input type="text" name="department.departmentName" id="departmentName" class="longinput"/></span>
                </p>
                <p>
                    <label for="departmentDuty">部门职责</label>
                    <span class="field"><textarea style="resize: none;" cols="80" rows="5" name="department.departmentDuty" id="departmentDuty" class="longinput"></textarea></span>
                </p>
...
<script type="text/javascript">
    ...
    function saveResource() {
        ...
        $("#addRole option").each(function(){
            arr+="&roleIds="+$(this).val();
        });
        jQuery.ajax({
            url:'/admin/rs/addOrUpdateDepartment.json',
            type:'post',
            data:arr,
            dataType:'json',
