	    ...
	    <div class="centercontent tables">
	         <div class="pageheader notab" style="margin-left: 30px">
                ...
                <span>
                    ...
                    1.本页面用于批量导入教职工<br />
                    2.点击
                    <%--<a href="${ctx}/static/exceltemplate/import_employee1.xls" style="color:red">下载excel模板</a>,--%>
             ...
             <div id="contentwrapper" class="contentwrapper">
				...
				<div id="validation" class="subcontent">
                    ...
                    <form id="form1" class="stdform" method="post" action="${ctx}/admin/rs/batchAddEmployeeSynchronization.json" enctype="multipart/form-data">
                        <p>
                        	<label>上传</label>
                            <span class="field">
