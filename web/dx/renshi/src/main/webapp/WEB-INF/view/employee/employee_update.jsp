            ...
            <form class="stdform stdform2" method="post" action="" id="updateEmployee">
                ...
                <p>
                    ...
                    <span class="field"><input type="text" readonly name="queryEmployee.birthDay" id="birthDay"  class="longinput"
                                               value="<fmt:formatDate value="${queryEmployee.birthDay}" pattern="yyyy-MM"/>" onblur="checkAge()"/></span>
                </p>
                <p>
                ...
                <p class="stdformbutton" style="text-align: center">
                    <button class="submit radius2" onclick="updateEmployee();return false;">修 改</button>
