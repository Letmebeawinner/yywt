        ...
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="updatecountryside">
                ...
                <p>
                    ...
                    <span class="field"><input type="text" readonly name="countryside.beginTime" id="beginTime" class="longinput"value="<fmt:formatDate value="${countryside.beginTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>结束时间</label>
                    <span class="field"><input type="text" readonly name="countryside.endTime" id="endTime" class="longinput"value="<fmt:formatDate value="${countryside.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/></span>
                </p>
