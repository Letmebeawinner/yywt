...
<div class="centercontent tables">
    ...
    <div class="pageheader notab" style="margin-left: 10px">
        <h1 class="pagetitle">我的奖惩记录</h1>
         <span>
                <span style="color:red">说明</span><br>
                1. 编辑奖惩记录：点击操作列中的<span style="color:red">编辑</span>按钮编辑奖惩记录；<br>
                2. 删除奖惩记录：点击操作列中的<span style="color:red">删除</span>按钮删除奖惩记录。
        </span>
    </div><!--pageheader-->
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <c:forEach items="${institutionList}" var="institution" varStatus="index">
                    <tr>
                        ...
                        <td><fmt:formatDate value="${institution.certificateTime}" type="date" dateStyle="long"/></td>
                        <td class="center">
                            <a href="${ctx}/admin/rs/toUpdateSelfInstitution.json?id=${institution.id}" class="stdbtn" title="编辑">编辑</a>
