    ...
    <div id="contentwrapper" class="contentwrapper">
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="addFamily">
                <p>
                    <input type="hidden" id="employeeId" name="family.employeeId" value="${employeeId}">
                    <label><em style="color: red;">*</em>称谓</label>
                    <span class="field"><input type="text" name="family.title" id="title" class="longinput"/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>姓名</label>
                    <span class="field"><input type="text" name="family.name" id="name" class="longinput"/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>出生年月</label>
                    <span class="field"><input type="text" readonly name="family.birthday" id="birthday"
                                               class="longinput"/></span>
                </p>
                <p>
                    <label><em style="color: red;">*</em>政治面貌</label>
                    <span class="field">
                      <input type="text" name="family.aspect" id="aspect" class="longinput"/>
                    </span>
                </p>
                <p>
                    <label>工作单位及职务</label>
                    <span class="field"><input type="text" name="family.unit" id="unit" class="longinput"/></span>
                </p>
