    ...
    <div id="contentwrapper" class="contentwrapper">
        <div id="basicform" class="subcontent">
            <form class="stdform stdform2" method="post" action="" id="addEducate">
                ...
                <p>
                    <input type="hidden" name="educate.employeeId" id="employeeId" class="longinput" value="${employee.id}"/>
                ...
                <p class="stdformbutton" style="text-align: center">
                    <button class="submit radius2" onclick="addSelfEducateFormSubmit();return false;">添 加</button>
