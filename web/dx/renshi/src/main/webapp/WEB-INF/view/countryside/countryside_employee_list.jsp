    ...
    <script type="text/javascript">
        ...
        function delEmployee(id, employeeId) {
            if (confirm("确定将该教职工从该活动中移除？")) {
                jQuery.ajax({
                    url: "${ctx}/admin/rs/deleteCountrysideEmployee.json",
                    data: {
        ...
        function updateEmployee(id,counttysideId) {
            if (confirm("确定该教职工已参加？")) {
                jQuery.ajax({
                    url: "${ctx}/admin/rs/updateCountrysideEmployee.json?",
                    data: {
...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="getEmployeeList" action="${ctx}/admin/rs/getCountrysideEmpList.json"
                      method="post">

                    <div class="disIb ml20 mb10">
                        <span class="vam">电话 &nbsp;</span>
                        <label class="vam">
                            <input type="text" class="hasDatepicker" placeholder="输入用户电话" name="queryEmployee.mobile"
                                   value="${queryEmployee.mobile}">
                        </label>
                    </div>
                </form>
                <div class="disIb ml20 mb10">
