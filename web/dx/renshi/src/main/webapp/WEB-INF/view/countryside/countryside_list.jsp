...
<div class="centercontent tables">
    ...
    <div id="contentwrapper" class="contentwrapper">
        <div class="overviewhead clearfix mb10">
            <div class="fl mt5">
                <form class="disIb" id="getCountrysideList" action="${ctx}/admin/rs/getCountrysideList.json" method="post">
                </form>
                <div class="disIb ml20 mb10">
                    <a href="${ctx}/admin/rs/toAddCountryside.json" class="stdbtn btn_orange" >新建</a>
                </div>
            </div>
        </div>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                ...
                <c:forEach items="${countrysideList}" var="countryside" varStatus="index">
                    <tr>
                        ...
                        <td class="center">
                            <a href="${ctx}/admin/rs/toUpdateCountryside.json?id=${countryside.id}" class="stdbtn" title="编辑">编辑</a>
                            <a href="${ctx}/admin/rs/getCountrysideEmpList.json?countrysideEmp.countrysideId=${countryside.id}" class="stdbtn" title="参与人员">预参与人员</a>
