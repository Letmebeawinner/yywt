    ...
    $.alerts = {
        ...
        _show: function (title, msg, value, type, callback) {
            ...
            switch (type) {
                ...
                /** 自定义弹框结构 **/
                case 'dialog' :
                    $("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '" id="popup_ok" /><input class="ml10" type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel" /></div>');
                    $("#popup_ok").click(function () {
                        callback(true);
                        $.alerts._hide();
                    });
        ...
        _reposition: function () {
            ...
            var top = ((window.innerHeight / 2) - (( typeof outerHeight === 'number' ? outerHeight : $("#popup_container")[0].clientHeight) / 2)) + $.alerts.verticalOffset;
            var left = ((window.innerWidth / 2) - ( (typeof outerWidth === 'number' ? outerWidth : $("#popup_container")[0].clientWidth) / 2)) + $.alerts.horizontalOffset;
            if (top < 0) top = 0;
            if (left < 0) left = 0;
