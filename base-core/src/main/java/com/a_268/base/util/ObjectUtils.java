...
public class ObjectUtils {
     ...
     */
    public static List<Map<String, String>> listObjToListMap(List<?> list){
        if(!CollectionUtils.isEmpty(list)){
            String stringListMap = gson.toJson(list);
            return gson.fromJson(stringListMap,new TypeToken<List<Map<String,String>>>(){}.getType());
        }
        return  null;
    }
